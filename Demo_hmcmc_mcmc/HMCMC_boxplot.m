...
epsilon = 1.5;  % force epsilon to be this value
...
%%
nrep = 100;
epsilon_list = repmat([0.1:0.2:1.5],nrep,1);
...
% save msplot_HMCMC_singlemode_boxplot.mat;


%%  box plot
load('msplot_HMCMC_singlemode_boxplot.mat');
figure
%plot(epsilon_list,ESS_all,'o-');
boxplot(ESS_all,epsilon_list(1,:),'Notch','on','OutlierSize',0.1);
%set(gca,'xtick',[]);
