%% ========================== post MCMC analysis ==========================
load fresult_subspace_NUTS_NoDA_v1_1584mcmc.mat
...
%% --- plot dPotE
figure('pos',[500,100,430,300]);
ha1 = subplot(2,1,1);
imagesc(abs(dPotE_mcmc)',[0,1000]);
colormap('jet');
...
hbar = colorbar('south');
set(hbar,'Color','w','Position',[0.65,0.6,0.22,0.04]);
